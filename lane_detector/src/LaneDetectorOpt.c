...
LaneDetectorParser_configfile (char * const filename, struct LaneDetectorParserInfo *args_info, int override, int initialize, int check_required)
{
  ...
  //file = fopen("src/lane_detector/src/Lanes-mode2.conf","r");
    file = fopen("src/lane_detector/src/Lanes-custom.conf","r");
  //file = fopen("src/lane_detector/src/Custom_Lanes.conf","r");
